...
sprintf("Mean of steps each day = %.3f", rmean)
sprintf("Mean of steps each day with imputed data = %.3f", imputed_rmean)
...
sprintf("Median of steps each day = %.3f", rmedian)
sprintf("Median of steps each day with imputed data = %.3f", imputed_rmedian)
